...
export const APIKEY_PROVIDERS = {
  ...
  "codebuddy-direct": { id: "codebuddy-direct", alias: "cbd", name: "CodeBuddy (Direct API)", icon: "smart_toy", color: "#1F77B4", textIcon: "CB", website: "https://www.codebuddy.ai", notice: { text: "Direct API key flow against codebuddy.ai/v2 (Bearer ck_...). Auto-injects required system message and forces stream=true. For Tencent OAuth flow, use the regular CodeBuddy provider.", apiKeyUrl: "https://www.codebuddy.ai" } },
